...
function Button({
    ...
    let classes = className(rest.className, 'flex items-center px-3 py-1.5 border', {
        'border-white border-2 bg-[#150578] text-white h-10 rounded-full': primary,
        ...
        'border-white bg-[#0E0E52] text-white h-6 w-6 md:w-8 md:h-8 lg:w-14 lg:h-14 rounded-full': bingo && selected,
        'border-white border-4 bg-[#150578] text-white opacity-25 cursor-default disabled': primary && disabled,
    })
